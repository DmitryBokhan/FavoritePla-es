  ...
  BootstrapDualListbox.prototype = {
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
        ...
        this.container.find('.moveall > i, .move > i').removeClass('fas fa-chevron-right').addClass('icon-arrow-right');
        this.container.find('.removeall > i, .remove > i').removeClass('fas fa-chevron-left').addClass('icon-arrow-left');
      } else {
        ...
        this.container.find('.moveall > i, .move > i').removeClass('icon-arrow-right').addClass('fas fa-chevron-right');
        this.container.find('.removeall > i, .remove > i').removeClass('icon-arrow-left').addClass('fas fa-chevron-left');
      }
      if (refresh) {
        refreshSelects(this);
      }
